...
class H2(vararg attributes: Attribute, function: Element.() -> Unit): ElementWithChildren(name = "h2"), HElement {
...
}    fun Element.H2(vararg attribute: Attribute, _children: Element.() -> Unit): H2 {
        val H2 = H2(
