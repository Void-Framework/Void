...
internal class JsPage(uuid: UUID, private val body: String) : Page<ContentType.Response>(
    ...
    companion object {
        fun addToMetadata(page: Page<ContentType.HtmlElements>, jsPage: JsPage) {
        ...
        fun addToMetadata(page: Page<ContentType.HtmlElements>, jsPage: List<JsPage>) {
            jsPage.forEach {
