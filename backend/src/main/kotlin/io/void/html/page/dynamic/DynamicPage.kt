...
fun dynamicJsonRoute(path: String, block: Map<String,String?>.() -> ResponseDTO): DynamicPage<ContentType.Response> =
...
fun dynamicHtmlRoute(path: String, metadata: Metadata.() -> Unit, block: ContentType.HtmlElements.() -> Unit): DynamicPage<ContentType.HtmlElements> =
