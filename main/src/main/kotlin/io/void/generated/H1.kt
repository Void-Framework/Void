...
class H1(vararg attributes: Attribute, function: Element.() -> Unit): ElementWithChildren(name = "h1"), HElement {
...
}    fun Element.H1(vararg attribute: Attribute, _children: Element.() -> Unit): H1 {
        val H1 = H1(
